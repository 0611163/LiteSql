...
namespace OracleTest
{
    ...
    {
        #region 变量
        private static ILiteSqlClient _liteSqlClient = new LiteSqlClient(ConfigurationManager.ConnectionStrings["MySQLConnection"].ToString(), DBType.MySQL);
        #endregion

        #region 静态构造函数
        static LiteSqlFactoryMySQL()
        {
