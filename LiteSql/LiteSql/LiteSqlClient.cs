...
namespace LiteSql
{
    ...
    /// LiteSqlClient是线程安全的
    /// </summary>
    public class LiteSqlClient<TFlag> : LiteSqlClient, ILiteSqlClient<TFlag>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数
        ...
        public LiteSqlClient(string connectionString, IProvider provider) : base(connectionString, provider) { }
        #endregion
    ...
    public class LiteSqlClient : ILiteSqlClient
    {
        ...
        /// <param name="connectionString">数据库连接字符串</param>
        /// <param name="provider">数据库提供者</param>
        public LiteSqlClient(string connectionString, IProvider provider)
        {
